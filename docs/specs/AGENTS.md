# AGENTS dla `docs/specs/`

Specyfikacje sa roboczym narzedziem dla przyszlych zmian, ktore maja nieoczywisty zakres, ryzyka lub kilka mozliwych rozwiazan.
...
- Po implementacji nie trzymaj zakonczonej specyfikacji jako dokumentacji stalej; przenies trwale ustalenia do `docs/contracts/` albo usun plik.
