...
4. [Kolejka uploadu i historia](upload-queue-and-history.md) opisuje lokalny spool, retry, limity i listę ostatnich nagrań.
5. [Statusy nagrania](recording-statuses.md) opisują wspólny kontrakt statusów rozszerzenia i backendu.
